...
export const UpdateMessages = observer(() => {
    if (stores.state.updateMessages && Object.getOwnPropertyNames(stores.state.updateMessages).length) {
        return (
            <div className="messages-to-send">
                <div className="update-messages-title">Updates that will be sent to the Pacer:</div>
                {
                    ...
                    Object.getOwnPropertyNames(stores.state.updateMessages).map(       // preset
                        (presetId, i) => {
